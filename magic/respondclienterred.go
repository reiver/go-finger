...
// RespondClientErred is a helper function that can be used by a finger-protocol server
// to tell a finger-protocol client that the finger-protocol cilent erred when trying
...
//		// ...
//		
//		err := finger.WriteResponseClientErred(rw, request)
//		
//		// ...
//		
//	}
func RespondClientErred(rw finger.ResponseWriter, request finger.Request) (e error) {
	if nil == rw {
		return errNilResponseWriter
	}

	const punctuation string = "!"
	const verb        string = "CLIENT-ERRED"
